...
const About = () => {
	return (
		<>
			<div className='flex flex-col lg:flex-row justify-center mt-20 mx-10 lg:mx-20'>
				<div className='lg:w-[45vw]  mr-8'>
					<h1 className='text-[#eb8d15] text-xs font-light'>
					...
					<button className='bg-[#1c4670] text-white px-6 mt-6 py-3 rounded-md'>
						Learn More
					</button>
				</div>
				<div className='flex mt-10 lg:w-[50vw] justify-center items-center'>
					<img
						className=' w-[30rem]'
						src={img1.src}
					/>
