...
const WhyChoose = () => {
	return (
		<>
			<div className='flex mt-20 mb-40 mx-20'>
				<div className='w-[60vw]'>
					...
					<p className='mt-4 w-[40ch] xl:w-[60ch]'>
				...
				<div className='flex flex-wrap justify-center gap-5'>
					<div className='flex flex-col justify-center items-center h-[13rem] w-[18rem] xl:w-[19rem] border-[#fcddec] rounded-md border-2 bg-[#fef3ef] '>
						<img
							className='h-12'
							src={shield.src}
						/>
					...
					<div className='flex flex-col justify-center items-center h-[13rem] w-[18rem] xl:w-[19rem] border-[#fcddec] rounded-md border-2 bg-[#f1fbf3] '>
						<img
							className='h-10'
					...
					<div className='flex flex-col justify-center items-center h-[13rem] w-[18rem] xl:w-[19rem] border-[#fcddec] rounded-md border-2 bg-[#edf3ff] '>
						<img
							className='h-10'
							src={smiley.src}
						/>
					...
					<div className='flex flex-col justify-center items-center h-[13rem] w-[18rem] xl:w-[19rem] border-[#fcddec] rounded-md border-2 bg-[#fbf1fb] '>
						<img
							className='h-12'
							src={person.src}
						/>
